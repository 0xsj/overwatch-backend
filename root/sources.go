...
func (m *me) registerResearch(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /v1/workspaces/{workspace}/records/{record}/revisions", m.listResearchRecordRevisions)
	mux.HandleFunc("PUT /v1/workspaces/{workspace}/records/{record}", m.editResearchRecord)
	mux.HandleFunc("POST /v1/workspaces/{workspace}/records/{record}/archive", m.archiveResearchRecord)
	mux.HandleFunc("POST /v1/workspaces/{workspace}/records/{record}/restore", m.restoreResearchRecord)
