...
var (
	...
	ErrResolutionSetSize    = errors.New(errors.Invalid, "a resolution set needs between two and four records")
	ErrResolutionSetOverlap = errors.New(errors.Invalid, "a resolution set cannot contain the canonical record twice")
