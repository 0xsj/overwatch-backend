...
var (
	...
	ErrContextHalfSet       = errors.New(errors.Invalid, "a question origin needs both a kind and an identifier")
	ErrContextKindUnknown   = errors.New(errors.Invalid, "not a question origin kind this system knows")
	ErrContextIDInvalid     = errors.New(errors.Invalid, "a question origin needs a valid identifier")
